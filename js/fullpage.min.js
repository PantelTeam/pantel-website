...
!function(e, t, n, o, i) {
    ...
    return e.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(t, n) {
        ...
        if (!Q(K("html"), a)) {
            ...
            }), Ne && (de.version = "3.0.2", de.setAutoScrolling = ft, de.setRecordHistory = dt, 
            de.setScrollingSpeed = vt, de.setFitToSection = pt, de.setLockAnchors = function(e) {
                F.lockAnchors = e;
            }, de.setMouseWheelScrolling = ht, de.setAllowScrolling = gt, de.setKeyboardScrolling = St, 
            de.moveSectionUp = bt, de.moveSectionDown = wt, de.silentMoveTo = yt, de.moveTo = Et, 
            de.moveSlideRight = Lt, de.moveSlideLeft = xt, de.fitToSection = Bt, de.reBuild = Tt, 
            de.setResponsive = At, de.getFullpageData = F, de.destroy = function(n) {
                ft(!1, "internal"), gt(!0), mt(!1), St(!1), ce(Ne, l), clearTimeout(_e), clearTimeout(Xe), 
                clearTimeout(We), clearTimeout(Ke), clearTimeout(qe), e.removeEventListener("scroll", Rt), 
                e.removeEventListener("hashchange", on), e.removeEventListener("resize", hn), t.removeEventListener("keydown", ln), 
                t.removeEventListener("keyup", an), [ "click", "touchstart" ].forEach(function(e) {
                ...
                for (var r in o.style.display = "block", t.body.insertBefore(o, null), i) void 0 !== o.style[r] && (o.style[r] = "translate3d(1px,1px,1px)", 
                ...
                $(Ne, {
                    height: "100%",
                    position: "relative"
                }), ce(Ne, n), ce(K("html"), a), je = G(), ue(Ne, l), ce(K(F.sectionSelector, Ne), p), 
                ce(K(F.slideSelector, Ne), k);
                for (var e = K(h), i = 0; i < e.length; i++) {
                    var r = i, s = e[i], u = K(M, s), f = u.length;
                    s.setAttribute("data-fp-styles", s.getAttribute("style")), m = s, (S = r) || null != K(g)[0] || ce(m, c), 
                    Ie = K(g)[0], $(m, {
                        height: je + "px"
                    }), F.paddingTop && $(m, {
                    ...
                    }), void 0 !== F.anchors[S] && m.setAttribute("data-anchor", F.anchors[S]), d = s, 
                    v = r, void 0 !== F.anchors[v] && Q(d, c) && bn(F.anchors[v], v), F.menu && F.css3 && null != he(K(F.menu)[0], o) && se.appendChild(K(F.menu)[0]), 
            ...
            }(), gt(!0), mt(!0), ft(F.autoScrolling, "internal"), gn(), Cn(), "complete" === t.readyState && nn(), 
            e.addEventListener("load", nn), e.addEventListener("scroll", Rt), e.addEventListener("hashchange", on), 
            e.addEventListener("blur", fn), e.addEventListener("resize", hn), t.addEventListener("keydown", ln), 
            t.addEventListener("keyup", an), [ "click", "touchstart" ].forEach(function(e) {
        ...
        function ht(n) {
            ...
            }(), Ne.addEventListener("mousedown", sn), Ne.addEventListener("mouseup", cn)) : (t.addEventListener ? (t.removeEventListener("mousewheel", Yt, !1), 
            t.removeEventListener("wheel", Yt, !1), t.removeEventListener("MozMousePixelScroll", Yt, !1)) : t.detachEvent("onmousewheel", Yt), 
            Ne.removeEventListener("mousedown", sn), Ne.removeEventListener("mouseup", cn));
        }
        function gt(e, t) {
        ...
        function Tt(t) {
            if (!Q(Ne, l)) {
                ...
                var s = ie(K(g)[0], h);
                s && yt(s + 1), Pe = !1, Ee(F.afterResize) && t && F.afterResize.call(Ne, e.innerWidth, e.innerHeight), 
                Ee(F.afterReBuild) && !t && F.afterReBuild.call(Ne);
            }
        }
        function At(e) {
            var t = Q(se, i);
            e ? t || (ft(!1, "internal"), pt(!1, "internal"), le(K(E)), ce(se, i), Ee(F.afterResponsive) && F.afterResponsive.call(Ne, e)) : t && (ft(et.autoScrolling, "internal"), 
            pt(et.autoScrolling, "internal"), ae(K(E)), ue(se, i), Ee(F.afterResponsive) && F.afterResponsive.call(Ne, e));
        }
        function kt(e) {
            var t = e.target;
            t && he(t, E + " a") ? function(e) {
                ...
                ye(e);
                var t = K(H, he(this, h))[0], n = K(M, t)[ie(he(this, "li"))];
                vn(t, n);
            }.call(t, e);
        }
        function Mt(e, n) {
        ...
        function Ct(e, n, o) {
            ...
            u.className = I, ve(n, u), $(K(R, e), {
                width: i + "%"
            }), o > 1 && (F.controlArrows && (a = e, s = [ Ae('<div class="' + Y + '"></div>'), Ae('<div class="' + W + '"></div>') ], 
            ge(K(H, a)[0], s), "#fff" !== F.controlArrowColor && ($(K(X, a), {
        ...
        function It() {
            var e, t = K(g)[0];
            ce(t, f), $t(t), Jt(t), F.scrollOverflow && F.scrollOverflowHandler.afterLoad(), 
        ...
        function Rt() {
            ...
            if (!F.autoScrolling || F.scrollBar) {
                var l = be(), a = (n = (t = l) > nt ? "down" : "up", nt = t, st = t, n), s = 0, u = l + G() / 2, d = se.offsetHeight - G() === l, v = K(h);
                if (d) s = v.length - 1; else if (l) for (var p = 0; p < v.length; ++p) v[p].offsetTop <= u && (s = p); else s = 0;
                if (o = a, i = K(g)[0].offsetTop, r = i + G(), ("up" == o ? r >= be() + G() : i <= be()) && (Q(K(g)[0], f) || (ce(K(g)[0], f), 
                ue(we(K(g)[0]), f))), !Q(e = v[s], c)) {
                    tt = !0;
                    ...
                    x && (S = x.getAttribute("data-anchor"), m = ie(x)), Ve && (ce(e, c), ue(we(e), c), 
                    Ee(F.onLeave) && Xt("onLeave", T), Ee(F.afterLoad) && Xt("afterLoad", T), en(b), 
                    $t(e), Jt(e), bn(E, L - 1), F.anchors.length && (Se = E), kn(m, S, E)), clearTimeout(Ke), 
        ...
        function Yt(t) {
            var n = new Date().getTime(), o = Q(K(d)[0], w);
            if (!Ue.m.down && !Ue.m.up) return ye(t), !1;
            if (F.autoScrolling && !He && !o) {
                var i = (t = t || e.event).wheelDelta || -t.deltaY || -t.detail, r = Math.max(-1, Math.min(1, i)), l = void 0 !== t.wheelDeltaX || void 0 !== t.deltaX, a = Math.abs(t.wheelDeltaX) < Math.abs(t.wheelDelta) || Math.abs(t.deltaX) < Math.abs(t.deltaY) || !l;
                Ye.length > 149 && Ye.shift(), Ye.push(Math.abs(i)), F.scrollBar && ye(t);
                var s = n - at;
                return at = n, s > 200 && (Ye = []), Ve && Vt(Ye, 10) >= Vt(Ye, 70) && a && zt(r < 0 ? "down" : "up"), 
                !1;
            }
            F.fitToSection && (Ge = !1);
        }
        ...
        function Wt(e, t, n) {
            if (null != e) {
                var o, i, r, l, a, s, u, f, d, v = {
                    ...
                    callback: t,
                    isMovementUp: n,
                    dtop: (i = (o = e).offsetHeight, r = o.offsetTop, a = r > st, s = (l = r) - je + i, 
                    u = F.bigSectionsDestination, i > je ? (a || u) && "bottom" !== u || (l = s) : (a || Pe && null == ne(o)) && (l = s), 
                    st = l, l),
                    yMovement: wn(e),
                ...
                if (!(v.activeSection == e && !Pe || F.scrollBar && be() === v.dtop && !Q(e, b))) {
                    if (null != v.activeSlide && (f = v.activeSlide.getAttribute("data-anchor"), d = ie(v.activeSlide)), 
                    ...
                    Rn(K(g)[0].offsetTop), Ft(), m.wrapAroundElements = m.activeSection, m.dtop = m.element.offsetTop, 
                    m.yMovement = wn(m.element), m.leavingSection = ie(m.activeSection, h) + 1, m.sectionIndex = ie(m.element, h), 
                    v = m), v.localIsResizing || en(v.activeSection), F.scrollOverflow && F.scrollOverflowHandler.beforeLeave(), 
                    ce(e, c), ue(we(e), c), $t(e), F.scrollOverflow && F.scrollOverflowHandler.onLeave(), 
                    Ve = de.test.isTesting, kn(d, f, v.anchorLink, v.sectionIndex), function(e) {
        ...
        function qt(t) {
            var n = {};
            return F.autoScrolling && !F.scrollBar ? (n.options = -t, n.element = K(o)[0]) : (n.options = t, 
            n.element = e), n;
        }
        function Qt(e) {
            var t;
            null != (t = e).wrapAroundElements && (t.isMovementUp ? me(K(h)[0], t.wrapAroundElements) : ge(K(h)[K(h).length - 1], t.wrapAroundElements), 
            Rn(K(g)[0].offsetTop), Ft()), Ee(F.afterLoad) && !e.localIsResizing && Xt("afterLoad", e), 
            F.scrollOverflow && F.scrollOverflowHandler.afterLoad(), e.localIsResizing || Jt(e.element), 
            ce(e.element, f), ue(we(e.element), f), Ve = !0, Ee(e.callback) && e.callback();
        }
        function Gt(e, t) {
        ...
        function nn() {
            var e = rn(), t = e.section, n = e.slide;
            t && (F.animateAnchor ? Tn(t, n) : yt(t, n));
        }
        function on() {
            if (!tt && !F.lockAnchors) {
                var e = rn(), t = e.section, n = e.slide, o = void 0 === Se, i = void 0 === Se && void 0 === n && !Re;
        ...
        function ln(e) {
            ...
            9 === o ? function(e) {
                ...
                (n = e, o = un(t), i = o.indexOf(t.activeElement), r = n.shiftKey ? i - 1 : i + 1, 
                l = o[r], a = Kt(he(l, M)), s = _t(he(l, h)), a || s) && (u ? null == he(u, g + "," + g + " " + O) && (u = d(e)) : d(e), 
            ...
            He = e.ctrlKey, Qe = setTimeout(function() {
                !function(e) {
                    var t = e.shiftKey;
        ...
        function vn(e, t, n) {
            ...
            l.xMovement = (o = l.prevSlideIndex, i = l.slideIndex, o == i ? "none" : o > i ? "left" : "right"), 
            l.localIsResizing || (Ve = !1), F.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && Ee(F.onSlideLeave) && !1 === Xt("onSlideLeave", l) ? Re = !1 : (ce(t, c), 
            ue(we(t), c), l.localIsResizing || (en(l.prevSlide), $t(t)), !F.loopHorizontal && F.controlArrows && (Te(K(U, r), 0 !== l.slideIndex), 
            Te(K(X, r), null != ne(t))), Q(r, c) && !l.localIsResizing && kn(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex), 
            function(e, t, n) {
                var o = t.destinyPos;
                if (F.css3) {
        ...
        function pn(e) {
            var t, n;
            t = e.slidesNav, n = e.slideIndex, F.slidesNavigation && null != t && (ue(K(u, t), c), 
            ce(K("a", K("li", t)[n]), c)), e.localIsResizing || (Ee(F.afterSlideLoad) && Xt("afterSlideLoad", e), 
            Ve = !0, Jt(e.destiny)), Re = !1;
        }
        function hn() {
            if (gn(), Be) {
        ...
        function gn() {
            var t = F.responsive || F.responsiveWidth, n = F.responsiveHeight, o = t && e.innerWidth < t, i = n && e.innerHeight < n;
        ...
        function bn(e, t) {
            var n, o, i, r;
            n = e, o = K(F.menu)[0], F.menu && null != o && (ue(K(u, o), c), ce(K('[data-menuanchor="' + n + '"]', o), c)), 
            i = e, r = t, F.navigation && null != K(E)[0] && (ue(K(u, K(E)[0]), c), ce(i ? K('a[href="#' + i + '"]', K(E)[0]) : K("a", K("li", K(E)[0])[r]), c));
        }
        function wn(e) {
        ...
        function kn(e, t, n, o) {
            var i = "";
            F.anchors.length && !F.lockAnchors && (e ? (null != n && (i = n), null == t && (t = e), 
            Me = t, Mn(i + "/" + t)) : null != e ? (Me = t, Mn(n)) : Mn(n)), Cn();
        }
        function Mn(t) {
        ...
        function Hn(e) {
            ...
            t.x = e.touches[0].pageX), t;
        }
        function In(e, t) {
            vt(0, "internal"), void 0 !== t && (Pe = !0), vn(he(e, H), e), void 0 !== t && (Pe = !1), 
        ...
        function jn() {
            ...
            _("error", "https://github.com/alvarotrigo/fullPage.js#options.")), Q(K("html"), a) ? _("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (F.continuousVertical && (F.loopTop || F.loopBottom) && (F.continuousVertical = !1, 
            ...
            F.scrollOverflow && null == F.scrollOverflowHandler && (F.scrollOverflow = !1, _("error", "The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before fullPage.js.")), 
        ...
        function Vn(e, t) {
            this.anchor = e.getAttribute("data-anchor"), this.item = e, this.index = ie(e, t), 
            this.isLast = this.index === K(t).length - 1, this.isFirst = !this.index;
        }
        function Yn(e) {
            Vn.call(this, e, h);
        }
